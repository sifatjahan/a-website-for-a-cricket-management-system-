  ...
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a href="homepage.php" class="navbar-left" style="margin-top: 0px">
		<img src="http://www.geosportz.com/Files/Sport/Cricket.png" width="50px" height="50px">
	</a>
      <a class="navbar-brand" href="home.html"><span><img src="" alt="" ></span>&nbsp;&nbsp;CriMS</a>
      <?php }else{ ?>
      <a href="login.php" class="navbar-left" style="margin-top: 0px"><img src="http://www.geosportz.com/Files/Sport/Cricket.png" width="50px" height="50px"></a>
      <a class="navbar-brand" href="home.html">&nbsp;&nbsp;CriMS</a>
      <?php } ?>
    </div>
