			...
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-md-7">
						...
						<br>
						<div class="row">
							<div class="col-md-3"><label for="nsuId">User ID:</label></div>
							<div class="col-md-9">
								<?php if(!empty($profile) && $profile['nsuId']!=NULL){ ?>
								<input type="text" name="nsuId" id="nsuId" class="form-control" placeholder="User ID" value="<?php echo $profile['nsuId']; ?>" required pattern="[0-9]{10}">
								<?php }else{ ?>
								<input type="text" name="nsuId" id="nsuId" class="form-control" placeholder="User ID" required pattern="[0-9]{10}">
								<?php } ?>
							</div>
						</div>
					</div>
