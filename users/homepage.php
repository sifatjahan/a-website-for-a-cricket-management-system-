				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<?php }else{ if($type=='faculty'){ ?>
							<img src="http://galileoenrichment.com/wp-content/uploads/2018/04/man.png" alt="" width="200px" height="200px">
						<?php }else{ ?>
							<img src="https://cdn1.iconfinder.com/data/icons/avatars-1-5/136/84-512.png" alt="" width="200px" height="200px">
						<?php }} ?>
						</div>
						...
						<div class="list-group">
							...
							<button type="button" class="list-group-item">ID: <b><?php echo $profile['nsuId']; ?></b></button>
							<?php } ?>
